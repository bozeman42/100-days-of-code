...
**Today's Progress**: Project: [Zombies of the North](https://github.com/bozeman42/zotn/) Today I worked on the process of scanning in any bullets / bites received and granting the appropriate players credits and points. I learned how to include multiple queries in a single transaction with node pg.
